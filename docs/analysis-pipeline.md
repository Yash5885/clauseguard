# Clause segmentation and similarity pipeline

This stage implements Section 5 Steps 2, 4, and 6 of the MVP specification. It
...
7. Clause rows, vectors, matches, labels, and the completed document status are
...
future explanation, original order, closest baseline ID, and similarity score.
...
the later explanation-generation stage can add grounded nuance without changing
the stored comparison evidence.
